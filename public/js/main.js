...
class PostDialogComponent {
    constructor(dialogRef) {
        ...
        this.nomeArquivo = '';
        this.dados = {
            post: new _posts__WEBPACK_IMPORTED_MODULE_1__["Post"]("", "", "", "", ""),
            arquivo: null
        };
    }
    ngOnInit() {
...
PostDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PostDialogComponent, selectors: [["app-post-dialog"]], decls: 31, vars: 6, consts: [["fxLayout", "column", "fxLayoutAlign", "space-around left"], ["fxLayout", "row", "fxLayoutAlign", "space-between"], ["fxFlex", "40"], ["matInput", "", "type", "text", "placeholder", "Seu nome", 3, "ngModel", "ngModelChange"], ["matInput", "", "type", "text", "placeholder", "Seu email", 3, "ngModel", "ngModelChange"], ["matInput", "", "type", "text", "placeholder", "Titulo da mensagem", 3, "ngModel", "ngModelChange"], ["matInput", "", "type", "text", "placeholder", "Sub-titulo da mensagem", 3, "ngModel", "ngModelChange"], ["matInput", "", "placeholder", "deixe aqui sua mensagem", 3, "ngModel", "ngModelChange"], ["type", "file", 2, "display", "none", 3, "change"], ["fileInput", ""], ["mat-stroked-button", "", "color", "primary", 3, "click"], [4, "ngIf"], [2, "text-align", "center"], ["mat-button", "", "color", "primary", 3, "click"], ["mat-button", "", "color", "warn", 3, "click"]], template: function PostDialogComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](9, "Digite aqui seu e-mail");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](23, PostDialogComponent_p_23_Template, 6, 1, "p", 11);
...
class PostService {
    constructor(http) {
        ...
        this.http.get('/api/').subscribe((posts) => {
            for (let p of posts) {
                this.posts.push(new _posts__WEBPACK_IMPORTED_MODULE_2__["Post"](p.nome, p.titulo, p.subtitulo, p.email, p.mensagem, p.arquivo, p.id, p.likes));
            }
        });
    }
    salvar(post, file) {
...
PostComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PostComponent, selectors: [["app-post"]], inputs: { post: "post" }, decls: 17, vars: 5, consts: [["fxFlex", "", 1, "card"], ["mat-card-avatar", ""], ["mat-card-image", "", "alt", "Photo of a Shiba Inu", 3, "src"], ["mat-button", "", "color", "primary", 3, "click"], ["mat-button", "", "color", "warn", 3, "click"], ["color", "warn", "matBadgePosition", "above after", "matBadgeColor", "warn", "matBadgeOverlap", "false", 3, "matBadge", 4, "ngIf"], ["color", "warn", "matBadgePosition", "above after", "matBadgeColor", "warn", "matBadgeOverlap", "false", 3, "matBadge"]], template: function PostComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! C:\Users\ededi\dev\fesper\fesper\angular-laravel\resources\app\src\main.ts */"./src/main.ts");
